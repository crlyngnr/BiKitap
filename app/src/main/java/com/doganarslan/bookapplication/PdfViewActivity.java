...
import com.doganarslan.bookapplication.databinding.ActivityPdfViewBinding;
...
public class PdfViewActivity extends AppCompatActivity {
    ...
    private void getBookName() {
        Log.d(TAG, "loadBookDetails: PDF URL'sini alın");
                        ...
                        binding.pdfView.fromBytes(bytes)
                                ...
                                .onPageError(new OnPageErrorListener() {
                                    ...
                                    public void onPageError(int page, Throwable t) {
                                        Toast.makeText(PdfViewActivity.this, "Sayfada Hata: "+page+t.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                })
                                .load();
